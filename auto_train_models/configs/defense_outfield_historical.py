# Historical Defense Outfield model configuration
#
...
#
# Train:
#   python scripts/train_models.py --model defense_outfield_historical --pretrain
#
...
class DefenseOutfieldHistoricalConfig:
    """LSTM config for historical outfield defense — UZR/150 based."""

    # ── Data ──────────────────────────────────────────────────────────────────
    DATA_FILE = '../data/historic_mlb/mlb_fielding_data_2000_2025_with_statcast.csv'
    SCALER_FILE = 'data/defense_outfield_historical_pretrain_scaler.pkl'
    CHECKPOINT_DIR = './checkpoints/historical'
    CHECKPOINT_FILE = 'OF_fielding_historical.pth'
    PRETRAIN_CHECKPOINT_FILE = 'OF_fielding_historical.pth'
    OUTPUT_FILE = '../data/generated/historical_values/pipeline/defense_outfield_predictions.csv'
    ...
    def get_data_config():
        return DataConfig(
            input_features=DefenseOutfieldHistoricalConfig.INPUT_FEATURES,
            seq_length=3,

...
const Card = ({ children, className = "" }: { children: React.ReactNode, className?: string }) => (
  <div className={`bg-white backdrop-blur-sm rounded-2xl 
              ...
              <div className="space-y-6">
                <div className="grid md:grid-cols-3 gap-6">
                  <div className="flex items-start gap-3 p-4 bg-white 
                    ...
                    <FaDatabase className="mt-1 text-brand-500 flex-shrink-0" />
                    <div>
                  ...
                  <div className="flex items-start gap-3 p-4 bg-white 
                                rounded-xl transition-colors">
                    <FaChalkboardTeacher className="mt-1 text-brand-500 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold text-gray-900 mb-2">
                        Data Processing
                      </h4>
                  ...
                  <div className="flex items-start gap-3 p-4 bg-white 
                                rounded-xl transition-colors">
                    <BsListStars className="mt-1 text-brand-500 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold text-gray-900 mb-2">
                        Data Integration
                      </h4>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <a href="https://github.com/nielsjsc/LSTMLB/blob/main/models/batter.ipynb"
                    ...
                    className="flex items-center gap-2 px-4 py-2 rounded-lg bg-emerald-500 
                            hover:bg-emerald-400 text-gray-900 transition-colors text-sm">
                    <FaGithub /> View Code
                  </a>
                </div>
              </div>
                    ...
                    <div className="space-y-4">
                      <div className="bg-white p-4 rounded-lg border-l-4 border-emerald-500">
                        ...
                        <div className="grid grid-cols-5 gap-2 text-xs">
                          <div className="col-span-4 space-y-1 text-gray-600">
              ...
              <div className="space-y-8">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  ...
                  <div className="bg-white rounded-xl p-6">
                    ...
                    <p className="text-xs text-gray-400 mt-4">All metrics normalized per inning pitched (except Age)</p>
                  </div>
                </div>
          ...
          <div className="bg-white rounded-xl p-6">
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-2">
                  <p className="font-medium text-gray-900">Value Metrics</p>
                ...
                <div className="space-y-2">
                  <p className="font-medium text-gray-900">Rate Stats</p>
                  <ul className="space-y-1 text-sm text-gray-600">
              ...
              <div className="space-y-8">
                ...
                <div className="bg-white rounded-xl p-6">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-3">
                      <h5 className="font-medium text-gray-900">Offensive Value</h5>
                      <ul className="space-y-1 text-sm text-gray-600">
                    ...
                    <div className="space-y-3">
                      <h5 className="font-medium text-gray-900">Defensive Value</h5>
                      <ul className="space-y-1 text-sm text-gray-600">
                ...
                <div className="bg-white rounded-xl p-6">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-3">
                      <h5 className="font-medium text-gray-900">Starting Pitchers</h5>
                      <ul className="space-y-1 text-sm text-gray-600">
                    ...
                    <div className="space-y-3">
                      <h5 className="font-medium text-gray-900">Relief Pitchers</h5>
                      <ul className="space-y-1 text-sm text-gray-600">
                  ...
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="space-y-2">
                      ...
                      <div className="bg-white p-3 rounded text-sm">
                        <p className="text-gray-600">$8M per WAR</p>
                        <p className="text-xs text-gray-400 mt-1">Bench to Average Starter</p>
                      </div>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="bg-white p-3 rounded text-sm">
                        <p className="text-gray-600">$9M per WAR</p>
                        <p className="text-xs text-gray-400 mt-1">Above Average to All-Star</p>
                      </div>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="bg-white p-3 rounded text-sm">
                        <p className="text-gray-600">$10M per WAR</p>
                        <p className="text-xs text-gray-400 mt-1">All-Star to MVP Level</p>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="space-y-8">
            <Card>
              ...
              <div className="space-y-8">
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <div className="bg-white p-3 rounded mt-2 text-sm">
                          <p className="text-gray-600">Minimum: $720K</p>
                          <p className="text-xs text-gray-400 mt-1">Cannot decrease from previous year</p>
                        </div>
                      </div>
                      <div>
                        <h5 className="text-sm font-medium text-gray-900">
                        ...
                        <div className="bg-white p-3 rounded mt-2 text-sm">
                          <p className="text-gray-600">25% of market value</p>
                          <p className="text-xs text-gray-400 mt-1">Minimum: $1M (Regular), $1.2M (Super Two)</p>
                        </div>
                      </div>
                    </div>
                    <div className="space-y-4">
                      <div>
                        ...
                        <div className="bg-white p-3 rounded mt-2 text-sm">
                          <p className="text-gray-600">33% of market value</p>
                          <p className="text-xs text-gray-400 mt-1">Minimum: $2.5M</p>
                        </div>
                      </div>
                      <div>
                        <h5 className="text-sm font-medium text-gray-900">
                        ...
                        <div className="bg-white p-3 rounded mt-2 text-sm">
                          <p className="text-gray-600">50% of market value</p>
                          <p className="text-xs text-gray-400 mt-1">Minimum: $4M</p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                {/* Key Rules */}
                <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-4">
                  <h4 className="font-medium text-gray-900 mb-2">Key Rules</h4>
                  <ul className="space-y-1 text-sm text-gray-600">
              ...
              <div className="space-y-8">
                ...
                <div className="bg-white rounded-xl p-6">
                  ...
                  <div className="font-mono text-sm space-y-2">
                    <div className="bg-white p-4 rounded">
                      ...
                      <p className="text-xs text-gray-400 mt-2">Summed across all team-control years</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-xl p-6">
                  ...
                  <div className="space-y-6">
                    <div className="grid md:grid-cols-2 gap-6">
                      <div>
                        <h5 className="text-sm font-medium text-gray-900 mb-3">Year 1</h5>
                      ...
                      <div>
                        <h5 className="text-sm font-medium text-gray-900 mb-3">Year 2</h5>
                        <div className="space-y-2 text-sm">
                          <div className="flex justify-between text-gray-600">
                            <span>Production Value:</span>
                            <span>$26.0M</span>
                ...
                <div className="bg-white rounded-xl p-6">
                  ...
                  <div className="grid md:grid-cols-3 gap-6 text-sm">
                    <div className="space-y-2">
                      <h5 className="font-medium text-gray-900">Years of Control</h5>
                      <p className="text-gray-600">
                        More team control years means more potential surplus value
                      </p>
                    </div>
                    <div className="space-y-2">
                      <h5 className="font-medium text-gray-900">Contract Status</h5>
                      <p className="text-gray-600">
                        Pre-arb and early arb years typically generate highest surplus
                      </p>
                    </div>
                    <div className="space-y-2">
                      <h5 className="font-medium text-gray-900">Performance Level</h5>
                      <p className="text-gray-600">
            ...
            <Card>
              ...
              <div className="space-y-8">
                ...
                <div className="bg-white rounded-xl p-6">
                  ...
                  <div className="grid md:grid-cols-4 gap-4">
                    <div className="bg-white p-3 rounded">
                      ...
                      <div className="text-sm text-gray-600">$180M</div>
                      <div className="text-xs text-gray-400 mt-1">Elite Prospects</div>
                    </div>
                    <div className="bg-white p-3 rounded">
                      <div className="text-lg font-medium text-emerald-600">60-65 FV</div>
                      <div className="text-sm text-gray-600">$90M-$120M</div>
                      <div className="text-xs text-gray-400 mt-1">Top Prospects</div>
                    </div>
                    <div className="bg-white p-3 rounded">
                      <div className="text-lg font-medium text-emerald-600">50-55 FV</div>
                      <div className="text-sm text-gray-600">$28M-$55M</div>
                      <div className="text-xs text-gray-400 mt-1">Average to Above</div>
                    </div>
                    <div className="bg-white p-3 rounded">
                      <div className="text-lg font-medium text-emerald-600">40-45 FV</div>
                      <div className="text-sm text-gray-600">$4M-$12M</div>
                      <div className="text-xs text-gray-400 mt-1">Depth Prospects</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-xl p-6">
                  ...
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="space-y-2">
                      <h5 className="text-sm font-medium text-gray-900">Top 100</h5>
                      <div className="text-sm text-gray-600">
                        0.9 → 0.5 multiplier
                        <p className="text-xs text-gray-400 mt-1">Linear decrease from #1 to #100</p>
                      </div>
                    </div>
                    <div className="space-y-2">
                      <h5 className="text-sm font-medium text-gray-900">Extended (101-500)</h5>
                      <div className="text-sm text-gray-600">
                        0.5 → 0.3 multiplier
                        <p className="text-xs text-gray-400 mt-1">Linear decrease from #101 to #500</p>
                      </div>
                    </div>
                    <div className="space-y-2">
                      <h5 className="text-sm font-medium text-gray-900">Unranked</h5>
                      <div className="text-sm text-gray-600">
                        0.3 multiplier
                        <p className="text-xs text-gray-400 mt-1">Minimum value floor</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-4">
                  <div className="space-y-2">
                    <h4 className="font-medium text-gray-900">Recent MLB Graduates</h4>
                    <p className="text-sm text-gray-600">
